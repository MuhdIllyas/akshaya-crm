...
const DashboardLayout = () => {
  ...
  const roleNavigation = {
    superadmin: [
      ...
      { path: "/dashboard/superadmin/knowledge_hub", label: "Knowledge Hub", icon: KnowledgeHubIcon },
    ...
    admin: [
      ...
      { path: "/dashboard/admin/knowledge_hub", label: "Knowledge Hub", icon: KnowledgeHubIcon },
