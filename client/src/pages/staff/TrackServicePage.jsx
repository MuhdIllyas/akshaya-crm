...
const TrackServicePage = () => {
  ...
  const getSavedFilters = () => {
    ...
    return { status: 'all', staff: 'all', expiry: 'all', viewMode: 'table' };
  };
  ...
  const [viewMode, setViewMode] = useState(initialFilters.viewMode || 'table');
  ...
  // Table row component - fixed overflow issue
    ...
    return (
      <>
        ...
        >
          ...
          <td className="px-4 py-3" onClick={(e) => e.stopPropagation()}>
            <EditableCell value={service.applicationNumber} serviceId={service.id} field="applicationNumber" type="text" />
          </td>
    ...
    <ErrorBoundary>
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center space-x-4">
                <div className="w-9 h-9 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-lg flex items-center justify-center shadow-lg flex-shrink-0">
                  <FiTarget className="h-5 w-5 text-white" />
                </div>
                <div>
                  <h1 className="text-xl font-bold text-gray-900">Service Management</h1>
                  <p className="text-gray-600 text-sm hidden sm:block">Track and manage service applications</p>
                </div>
              </div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex items-center bg-gray-100 rounded-lg p-1">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all flex items-center gap-1 ${
                      viewMode === 'sidebar' ? 'bg-white shadow-sm text-indigo-600' : 'text-gray-600 hover:text-gray-900'
                    }`}
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 mb-6 shadow-sm">
            <div className="flex flex-col md:flex-row md:items-center gap-3">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Search name, phone, service, app no..."
          ...
          {/* View Modes */}
          {viewMode === 'table' ? (
            /* Table View - responsive with fixed overflow handling */
            ...
            /* Sidebar View - responsive grid layout */
                  ...
                  <div className="space-y-6">
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                        <div className="flex items-center space-x-4">
                          <div className="w-16 h-16 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                            <FiUser className="h-8 w-8 text-white" />
                          </div>
                          <div>
                            <h2 className="text-xl md:text-2xl font-bold text-gray-900">{selectedService.customerName || 'Unknown'}</h2>
                      ...
                      <div className="border-b border-gray-200 overflow-x-auto">
                        <nav className="flex -mb-px">
                          {['overview', 'tracking', 'documents', 'history'].map((tab) => (
                            <button
                              key={tab}
                              className={`flex-1 py-4 px-4 text-center font-medium text-sm border-b-2 transition-colors whitespace-nowrap ${
                                activeTab === tab
                                  ? 'border-indigo-500 text-indigo-600'
                                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                              }`}
