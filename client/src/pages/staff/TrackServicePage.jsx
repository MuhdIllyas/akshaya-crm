  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Pipeline view of all service applications</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <button onClick={handleExportExcel}
                  className="hidden md:flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 text-gray-700 text-xs font-medium rounded-lg hover:bg-gray-50 transition-colors">
        ...
        {/* ================= KPI STRIP ================= */}
        <div className="px-5 lg:px-6 py-4 flex-shrink-0">
        ...
        {/* ================= FILTER BAR ================= */}
        <div className="px-5 lg:px-6 flex-shrink-0">
        ...
        {/* ================= CONTENT ================= */}
        <div className="flex-1 min-h-0 px-5 lg:px-6 py-4">
          {viewMode === 'board' ? (
            <KanbanBoard
...
/* ============================================================
   KANBAN BOARD
   ============================================================ */
const KanbanBoard = ({ columns, servicesByStatus, statusConfig, priorityConfig, selectedServiceId, onCardClick, onNotify, onQuickStatusChange }) => {
  return (
    <div className="h-full overflow-x-auto scrollbar-hide">
      <div className="flex gap-4 min-h-full pb-2" style={{ minWidth: 'max-content' }}>
        {columns.map(columnName => {
          ...
          return (
            <div key={columnName}
              className="flex flex-col w-[300px] flex-shrink-0 bg-gray-100/70 rounded-xl border border-gray-200 max-h-full">
              {/* Column header */}
              <div className="p-3 border-b border-gray-200 flex-shrink-0">
                <div className="flex items-center justify-between gap-2 mb-1.5">
                  <div className="flex items-center gap-2 min-w-0">
                    <span className={`w-2 h-2 rounded-full flex-shrink-0 ${cfg.dot}`}></span>
                    <h3 className="text-sm font-bold text-gray-900 truncate">{columnName}</h3>
                    <span className="text-[10px] font-bold px-1.5 py-0.5 bg-white border border-gray-200 text-gray-600 rounded-full">
                      {items.length}
                    </span>
                  </div>
                  <button className="p-1 rounded-md text-gray-400 hover:text-gray-700 hover:bg-white transition-colors">
...
/* ============================================================
   KANBAN CARD
   ============================================================ */
const KanbanCard = ({ service, statusConfig, priorityConfig, isSelected, onClick, onNotify, onQuickStatusChange }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -2 }}
      onClick={onClick}
      className={`bg-white rounded-lg border p-3 cursor-pointer transition-all duration-200 group ${
        isSelected
      ...
      <div className="flex items-start gap-2 mb-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-xs font-bold text-gray-900 truncate leading-tight">{service.customerName}</p>
      ...
      {/* Service line */}
      <div className="mb-2">
        <p className="text-xs font-medium text-gray-800 truncate">{service.serviceType}</p>
        <p className="text-[10px] text-gray-500 truncate">{service.subcategoryName || 'N/A'}</p>
      </div>

      {/* App no + Progress */}
      <div className="flex items-center justify-between gap-2 mb-2">
        <span className="text-[10px] text-gray-500 font-mono truncate">{service.applicationNumber}</span>
