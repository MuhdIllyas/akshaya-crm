...
const CampaignTokenManagementStaff = () => {
  ...
  const fetchCampaignTokens = async () => {
    ...
    try {
      ...
      // Safe extraction: ensure campaigns array exists
  ...
  // Safe filtering: ensure campaigns is an array
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 rounded-xl hover:bg-indigo-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Expand All
              </button>
              <button
                onClick={collapseAll}
                disabled={!campaigns.length}
                className="px-4 py-2 text-sm font-medium text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Collapse All
              </button>
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      {!isCampaignActive(campaign.campaign_start, campaign.campaign_end) && campaign.campaign_start && campaign.campaign_end && (
                                ...
                                <tr key={token.token_id} className="hover:bg-gray-50 transition-colors">
                                  ...
                                  <td className="py-4 px-6">
                                    <div className="text-sm text-gray-600">
                                      {token.token_created_at ? new Date(token.token_created_at).toLocaleDateString() : '—'}
                                    </div>
                                    {token.last_updated && (
