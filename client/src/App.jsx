      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/dashboard" element={<DashboardLayout />}>
            ...
            />
            <Route
              path="superadmin/expensemanagement"
              element={<ProtectedRoute allowedRoles={["superadmin"]}><AdminExpenseManagement /></ProtectedRoute>}
            />
            <Route
              path="superadmin/teams"
              element={<ProtectedRoute allowedRoles={["superadmin"]}><TeamManagement /></ProtectedRoute>}
            />
            <Route
            ...
            <Route
              ...
              element={<ProtectedRoute allowedRoles={["superadmin"]}><CommunicationSettings /></ProtectedRoute>}
            />
            <Route
              path="staff/token"
            ...
            <Route
              path="staff/notes"
              element={<ProtectedRoute allowedRoles={["staff", "supervisor"]}><NotesPage /></ProtectedRoute>}
            />
            <Route
